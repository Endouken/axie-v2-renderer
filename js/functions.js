...
recording.add(options, 'format', ['png', 'webm-mediarecorder']); //webm
...
$(document).ready(function () {
    //localStorage.setItem("transparency", false) // Almacena la variable cuyo nombre es nombre y el valor es constructor
